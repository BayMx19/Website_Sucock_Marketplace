<div class="sidebar-header">
    <a href="/admin/home"><img class="main-logo" src="{{ asset('assets') }}/img/logo WEB.jpg" alt="" style="width: 60px;" /></a>
</div>
<div class="nalika-profile">
                    <div class="profile-dtl">
        <a href="#"><img src="{{ asset('assets') }}/img/admin.jpeg" alt="Foto Admin" /></a>
        <h2>Fifit</h2>
    </div>
</div>
    ...
    <nav class="sidebar-nav left-sidebar-menu-pro">
        <ul class="metismenu" id="menu1">
            ...
            <li style="color: #ffffff;">
                <a class="has-arrow" href="#" aria-expanded="false"><i class="fa-solid fa-envelope" style="color: #fefefe;"></i> <span class="mini-click-non" style=" color: #fff;">Pesan</span></a>
                <ul class="submenu-angle" aria-expanded="false">
                    <li><a title="Semua Pesan" href="/admin/datapesan"><span class="mini-sub-pro" style=" color: #fff;">Semua Pesan
                        </span></a></li>
                </ul>
            </li>
            <li><a href=""><i class="fa-solid fa-power-off" style="color: #ffffff;"></i><span class="mini-click-non"> Log Out</span></a>
        </ul>
    </nav>
</div>
