                        ...
                        <div class="login_part_form_iner">
                            <form class="row contact_form" action="" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                <div class="col-md-12 form-group p_star">
                                    <label style="margin-left: 10px;">Foto Profil Toko</label>
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Toko" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <textarea type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Toko" required></textarea>
                                </div>
                                <div class="col-md-12 form-group p_star">
