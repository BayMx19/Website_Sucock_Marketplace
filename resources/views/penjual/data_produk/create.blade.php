                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                                                ...
                                                                                <input type="text" id="nama_produk" name="nama_produk" class="form-control" placeholder="Masukkan Nama Produk Anda">
                                                                            </div>

                                                                            {{-- Harga --}}
                                                                            <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                                                <span class="input-group-addon"><i class="fa-solid fa-tag" style="color: #ffffff;"></i> Harga</span>
                                                                                <input type="text" id="harga" name="harga" class="form-control" placeholder="Masukkan Harga Produk Anda">
                                                                            </div>

                                                                            {{-- Stok --}}
                                                                            <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                                                <span class="input-group-addon"><i class="fa-solid fa-warehouse" style="color: #ffffff;"></i> Stok</span>
                                                                                <input type="text" id="stok" name="stok" class="form-control" placeholder="Masukkan Stok Produk Anda">
                                                                            </div>

                                                                            {{-- Deskripsi --}}
                                                                            <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                                                <span class="input-group-addon"><i class="fa-solid fa-align-left" style="color: #ffffff;"></i> Deskripsi</span>
                                                                                <input type="text" id="deskripsi" name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi Produk Anda">
                                                                            </div>
                                                                                ...
                                                                                <div class="form-select-list">
                                                                                    <select class="form-control custom-select-value" id="promo_id" name="promo_id">
                                                                                        ...
                                                                                        @foreach($promos as $promo)
                                                                                            <option value="{{ $promo->id }}" data-diskon="{{ $promo->diskon_persen }}">{{ $promo->nama }} - {{ $promo->diskon_persen }}%</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 text-center">
                                                                    <div class="login-horizental cancel-wp">
                                                                        <button class="btn_1" type="submit">Simpan Data</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
