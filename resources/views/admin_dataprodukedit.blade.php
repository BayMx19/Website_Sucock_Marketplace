                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            ...
                                                            <input type="text" id="nama produk" name="nama produk" class="form-control" placeholder="Nama Produk" value="JP Gold">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            <span class="input-group-addon"><i class="fa-solid fa-layer-group" style="color: #ffffff;"></i> Stok</span>
                                                            <input type="text" id="stok" name="stok" class="form-control" placeholder="Stok" value="10">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms">
                                                            ...
                                                            <input type="text" id="harga" harga="harga" class="form-control" placeholder="Harga" value="100.000">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms">
                                                            <span class="input-group-addon"> <i class="fa-solid fa-circle-info" style="color: #ffffff;"></i> Deskripsi Produk</span>
                                                            <textarea cols="50" id="deskripsi" name="deskripsi produk" class="form-control" placeholder="Deskripsi Produk" >- Kualitas tinggi, desain elegan, dan cocok untuk pertandingan.<br />
                                                                - Bahan : bulu entok berkualitas<br />
                                                                - Berat : 250 Gram </h5></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
