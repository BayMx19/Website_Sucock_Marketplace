                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            ...
                                                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama" value="fifitsyafaaty">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms" style="margin-bottom: 25px;">
                                                            ...
                                                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat User">Ds. Krajanpatuk</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
