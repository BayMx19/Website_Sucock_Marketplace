                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            ...
                                                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama" value="Ily">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            <span class="input-group-addon"><i class="fa-solid fa-id-card" style="color: #fefefe;"></i> Username</span>
                                                            <input type="text" id="user" name="user" class="form-control" placeholder="Username" value="ily10">
                                                        </div>
                                                        {{-- <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            <span class="input-group-addon"><i class="fa-solid fa-shop" style="color: #ffffff;"></i> Nama Toko</span>
                                                            <input type="text" id="nama" name="nama toko" class="form-control" placeholder="Nama Toko" value="Ily">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms">
                                                            ...
                                                            <input type="email" id="email" name="email" class="form-control" placeholder="Email" value="ily10@gmail.com">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms">
                                                            <span class="input-group-addon"><i class="fa-solid fa-phone" style="color: #ffffff;"></i> No. Hp</span>
                                                            <input type="number" id="nohp" name="nohp" class="form-control" placeholder="No Hp" value="081028470001">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms" style="margin-bottom: 25px;">
                                                            ...
                                                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat Toko">Ds.Sumengko</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
