                                                ...
                                                <div class="row">
                                                                    ...
                                                                    <div class="product-edt-pix-wrap">
                                                                        <div class="mg-b-pro-edt file-upload-inner ts-forms">
                                                                            <div class="input-group">
                                                                                <span class="input-group-addon"> <i class="fa-solid fa-image" style="color: #ffffff;"></i> Profil Toko</span>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt mg-l-pro-edt ts-forms">
                                                            ...
                                                            <input type="text" id="nama" name="nama toko" class="form-control" placeholder="Nama Toko">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt mg-r-pro-edt ts-forms" style="margin-bottom: 25px;">
                                                            ...
                                                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat Toko"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
